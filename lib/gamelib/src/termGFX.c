...
static const uint16_t color_pallets[][4] =
{
		...
		{RGB565_TO_BGR565(0), RGB565_TO_BGR565(0x601f), RGB565_TO_BGR565(0xffff), RGB565_TO_BGR565(0x2104)}, /* boss: purple hat / white body / dark features */
		{RGB565_TO_BGR565(0), RGB565_TO_BGR565(ST7735_CYAN), RGB565_TO_BGR565(ST7735_CYAN), RGB565_TO_BGR565(ST7735_WHITE)},
		{RGB565_TO_BGR565(0), RGB565_TO_BGR565(ST7735_MAGENTA), RGB565_TO_BGR565(ST7735_MAGENTA), RGB565_TO_BGR565(ST7735_WHITE)},
		{RGB565_TO_BGR565(0), RGB565_TO_BGR565(ST7735_WHITE), RGB565_TO_BGR565(ST7735_BLACK), RGB565_TO_BGR565(ST7735_WHITE)},
};
