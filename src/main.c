...
static const uint8_t boss_sprite_data[((G2_BOSS_W + 3) / 4) * G2_BOSS_H] = {
    /* palette 7: 0=transparent, 1=red, 2=yellow, 3=white */
    ...
    0x54, 0x10, 0x2a, 0xa8, 0x04, 0x11,  /* belt (yellow) */
    0x54, 0x40, 0x00, 0x00, 0x01, 0x04,
    0x54, 0x43, 0xc0, 0x03, 0xc1, 0x04,  /* eyes (white) */
    0x00, 0x43, 0xc0, 0x03, 0xc1, 0x04,  /* eyes (white) */
    0x15, 0x03, 0xc0, 0x03, 0xc0, 0x54,  /* eyes (white) */
    0x40, 0x40, 0x00, 0x00, 0x01, 0x01,
    0x40, 0x40, 0x00, 0x00, 0x01, 0x01,
    0x40, 0x00, 0x20, 0x08, 0x00, 0x01,  /* mouth dots (yellow) */
    0x40, 0x40, 0x0a, 0xa0, 0x01, 0x01,  /* smile (yellow) */
